...
function Kids() {
  const Kidsdata = [
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example1.jpg",
      imageAlt: "Kid's",
      price: 299,
      Discount: "$40",
      color: "Blue",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example2.jpg",
      imageAlt: "Kid's",
      price: 499,
      Discount: "$60",
      color: "Navy",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example3.jpg",
      imageAlt: "Kid's",
      price: 349,
      Discount: "$50",
      color: "Yellow",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example4.jpg",
      imageAlt: "Kid's",
      price: 599,
      Discount: "$70",
      color: "Red",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example5.jpg",
      imageAlt: "Kid's",
      price: 699,
      Discount: "$90",
      color: "Black",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example6.jpg",
      imageAlt: "Kid's",
      price: 449,
      Discount: "$55",
      color: "White",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example7.jpg",
      imageAlt: "Kid's",
      price: 379,
      Discount: "$45",
      color: "Green",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example8.jpg",
      imageAlt: "Kid's",
      price: 749,
      Discount: "$100",
      color: "Grey",
    ...
    },
    {
      ...
      imageSrc: "https://assets.ajio.com/medias/sys_master/root/20240501/example9.jpg",
      imageAlt: "Kid's",
      price: 429,
      Discount: "$50",
      color: "Orange",
