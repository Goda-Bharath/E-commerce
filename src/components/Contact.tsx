function Contact() {
    return (
        <div>
            <div className="isolate bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 z-50 bg-gradient-to-r from-indigo-900 via-purple-900 to-cyan-700/80 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-cyan-400/40 shadow-lg">
                <div
                    aria-hidden="true"
